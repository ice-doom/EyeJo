...
from plugin.pocsuite3.lib.core.data import logger, paths
from plugin.pocsuite3.lib.core.enums import CUSTOM_LOGGING, OS, OS_ARCH, SHELLCODE_CONNECTION
# for pocsuite 2.x
from plugin.pocsuite3.lib.core.exception import PocsuiteGenericException
from plugin.pocsuite3.lib.core.register import register_poc as register
from plugin.pocsuite3.shellcodes import OSShellcodes
