...
from plugin.pocsuite3.lib.core.clear import remove_extra_log_message
from plugin.pocsuite3.lib.core.common import boldify_message, check_file, get_file_items, parse_target, \
    get_public_type_members, data_to_stdout
from plugin.pocsuite3.lib.core.common import check_path, extract_cookies
from plugin.pocsuite3.lib.core.common import get_local_ip, desensitization
from plugin.pocsuite3.lib.core.common import single_time_warn_message
from plugin.pocsuite3.lib.core.convert import stdout_encode
from plugin.pocsuite3.lib.core.data import conf, cmd_line_options
from plugin.pocsuite3.lib.core.data import kb
from plugin.pocsuite3.lib.core.data import logger
from plugin.pocsuite3.lib.core.data import merged_options
from plugin.pocsuite3.lib.core.data import paths
from plugin.pocsuite3.lib.core.datatype import AttribDict
from plugin.pocsuite3.lib.core.enums import HTTP_HEADER, CUSTOM_LOGGING, PROXY_TYPE
from plugin.pocsuite3.lib.core.exception import PocsuiteSyntaxException, PocsuiteSystemException, PocsuiteHeaderTypeException
from plugin.pocsuite3.lib.core.log import FORMATTER
from plugin.pocsuite3.lib.core.register import load_file_to_module
from plugin.pocsuite3.lib.core.settings import DEFAULT_USER_AGENT, DEFAULT_LISTENER_PORT, CMD_PARSE_WHITELIST
from plugin.pocsuite3.lib.core.statistics_comparison import StatisticsComparison
from plugin.pocsuite3.lib.core.update import update
from plugin.pocsuite3.lib.parse.cmd import DIY_OPTIONS
from plugin.pocsuite3.lib.parse.configfile import config_file_parser
from plugin.pocsuite3.lib.request.patch import patch_all
from plugin.pocsuite3.modules.listener import start_listener
from plugin.pocsuite3.thirdparty.oset.orderedset import OrderedSet
from plugin.pocsuite3.thirdparty.pysocks import socks
...
def _set_pocs_modules():
    ...
    if conf.poc:
        # step1. load system packed poc from plugin.pocsuite3/pocs folder
        ...
        for root, dirs, files in os.walk(paths.POCSUITE_POCS_PATH):
            for _dir in dirs:
                for x in os.listdir(paths.POCSUITE_POCS_PATH + '/' + _dir):
                    if x not in ['__init__.py', '__init__.pyc']:
                        exists_poc_with_ext.append(_dir + '/' + x)
