...
from plugin.pocsuite3 import __version__
from plugin.pocsuite3.lib.core.revision import get_revision_number
...
POC_IMPORTDICT = {
    ...
    "from pocsuite.net import req": "from plugin.pocsuite3.lib.request import requests as req",
    "from pocsuite.api.request import req": "from plugin.pocsuite3.lib.request import requests as req",
    "from pocsuite.poc import": "from plugin.pocsuite3.lib.core.poc import",
    "from pocsuite.api.poc import": "from plugin.pocsuite3.lib.core.poc import",
    "from pocsuite.utils import register": "from plugin.pocsuite3.lib.core.register import register_poc as register",
    "from pocsuite.lib.utils.funs import randomStr": "from plugin.pocsuite3.lib.utils import random_str as randomStr",
    "from pocsuite.api.utils import randomStr": "from plugin.pocsuite3.lib.utils import random_str as randomStr",
    "from pocsuite.lib.utils.funs import url2ip": "from plugin.pocsuite3.lib.utils import url2ip",
    "from pocsuite.api.utils import url2ip": "from plugin.pocsuite3.lib.utils import url2ip",
    ".content": ".text",
}
